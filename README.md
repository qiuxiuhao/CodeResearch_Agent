...
v1.0 明确不包含登录系统、复杂部署、PDF 导出、Graphviz 渲染、PNG/SVG 图导出、复杂 RAG、官方文档在线检索、人工编辑知识库、论文图表解析等功能。
...
`npm run build` 时 Mermaid 可能产生构建体积警告，这不影响 v1.0 前端运行。后续版本可以通过 dynamic import 或 code splitting 优化体积。
