...
app.include_router(retrieval_router, include_in_schema=False)
app.include_router(research_agent_router, include_in_schema=False)
app.include_router(alignment_router, include_in_schema=False)
app.include_router(observability_router, include_in_schema=False)
app.include_router(evaluation_router, include_in_schema=False)
app.include_router(evaluation_catalog_router, include_in_schema=False)
app.include_router(bad_case_router, include_in_schema=False)
