...
def build_analysis_graph():
    try:
        ...
        return _SequentialGraph([unzip_node, repo_scan_node, code_parse_node, file_analyze_node, report_generate_node])
    ...
    workflow.add_edge("file_analyze", "report_generate")
